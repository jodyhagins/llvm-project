...
TEST(ConfigParseTest, ParsesConfigurationBools) {
  ...
  CHECK_PARSE_BOOL(AllowBreakAfterTypeDeclarationParen);
  ...
  CHECK_PARSE_BOOL(BreakBeforeQualifiedFunction);
  ...
  CHECK_PARSE_BOOL(ExtraSpaceFollowingConstructorInitializers);
  ...
  CHECK_PARSE_BOOL(ReplaceLogicalNot);
  ...
  CHECK_PARSE_BOOL(SpaceBeforeOverloadedOperator);
