...
struct ScalarEnumerationTraits<FormatStyle::BreakInheritanceListStyle> {
  static void enumeration(IO &IO,
    ...
    IO.enumCase(Value, "BeforeEither", FormatStyle::BILS_BeforeEither);
  }
};
...
template <> struct MappingTraits<FormatStyle> {
  static void mapping(IO &IO, FormatStyle &Style) {
    ...
    IO.mapOptional("AllowBreakAfterTypeDeclarationParen",
    ...
    IO.mapOptional("AnonymousNamespaceText", Style.AnonymousNamespaceText);
    ...
    IO.mapOptional("ExtraSpaceFollowingConstructorInitializers",
                   Style.ExtraSpaceFollowingConstructorInitializers);
    ...
    IO.mapOptional("SpaceBeforeOverloadedOperator",
...
FormatStyle getLLVMStyle(FormatStyle::LanguageKind Language) {
  ...
  LLVMStyle.AllowBreakAfterTypeDeclarationParen = false;
  ...
  LLVMStyle.AnonymousNamespaceText = "";
  ...
  LLVMStyle.ExtraSpaceFollowingConstructorInitializers = true;
  ...
  LLVMStyle.SpaceBeforeOverloadedOperator = false;
